...
try{
 ...
 if($gad!="" ){
$query=$conn->exec("insert into kitap (kitap_ad,katag_id,tur_id) VALUES('$gad','$gad1','$gad2')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Kitap Ekle</h1>
                    </div>
...
?>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    ...
    <input type="text" id="fname" name="gad"  placeholder="Kitap adı">
