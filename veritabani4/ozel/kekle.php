...
try{
 ...
 if($gad1!="" ){
$query=$conn->exec("insert into kategori (kat_ad) VALUES('$gad1')");
if($query)
header ('Location:kekle.php?sonuc=basarı');
else	
header ('Location:kekle.php?sonuc=not');
}
else
header ('Location:kekle.php?sonuc=not');
}
...
?>
  <form action="kekle.php" method="post">

  <input type="hidden" value="" id="garson_id" name="id">
  
    <label for="fname">Kategori adı</label>
    <input type="text" id="fname" name="gad"  placeholder="Kategori">
