...
try{
 ...
 if($gad!="" ){
$query=$conn->exec("insert into stok_ihtiyac (ihtiyac_miktar,ih_kitap_id) VALUES('$gad','$gad2')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">İhtiyac kitap Ekle</h1>
                    </div>
...
?>
  ...
  <input type="hidden" value="" id="garson_id" name="id">
    <label for="fname2">Kitap adı</label>
...
while ($row = $query->fetch()) {
  echo "<option value=".$row['kitap_id']." selected>".$row['kitap_ad']."</option>";
}
   ?>
    </select>
    <label for="fname">Kitap miktarı</label>
